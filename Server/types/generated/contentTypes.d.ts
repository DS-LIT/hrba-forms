...
export interface ApiReimbursementFormReimbursementForm
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bsb: Schema.Attribute.BigInteger;
    club_name: Schema.Attribute.String;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reimbursement-form.reimbursement-form'
    > &
      Schema.Attribute.Private;
    player_name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTribunalReportFormTribunalReportForm
  extends Struct.CollectionTypeSchema {
  collectionName: 'tribunal_report_forms';
  info: {
    description: '';
    displayName: 'Tribunal Report Form';
    pluralName: 'tribunal-report-forms';
    singularName: 'tribunal-report-form';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    allegations: Schema.Attribute.JSON &
      ...
      > &
      Schema.Attribute.DefaultTo<'[]'>;
    co_official: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tribunal-report-form.tribunal-report-form'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    person_notified: Schema.Attribute.Boolean;
    person_on_report: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    signature: Schema.Attribute.String;
    summary: Schema.Attribute.Text;
    team_1_colour: Schema.Attribute.Enumeration<
      [
        'Red',
        'Blue',
        'Green',
    ...
    >;
    team_1_name: Schema.Attribute.String;
    team_2_colour: Schema.Attribute.Enumeration<
      [
        'Red',
        'Blue',
        'Green',
    ...
    >;
    team_2_name: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::reimbursement-form.reimbursement-form': ApiReimbursementFormReimbursementForm;
      'api::tribunal-report-form.tribunal-report-form': ApiTribunalReportFormTribunalReportForm;
